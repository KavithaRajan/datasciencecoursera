...
/* Line 268 of yacc.c  */
#line 1 "rasp_constituency_parse.y"
...
{
       0,     0,     3,     4,     5,     6,    14,    16,    19,    21
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
       8,     0,    -1,    -1,    -1,    -1,     3,     9,     5,    10,
      12,    11,     4,    -1,     8,    -1,    12,     8,    -1,     6,
      -1,    12,     6,    -1
};
...
{
       0,    62,    62,    71,    84,    62,    95,    97,   100,   109
};
#endif
...
/* Line 1806 of yacc.c  */
#line 62 "rasp_constituency_parse.y"
    {found=0;my_level++;
                            for(j=0;j<index1;j++)
...
/* Line 1806 of yacc.c  */
#line 84 "rasp_constituency_parse.y"
    { 
                             strncpy(my_temp[my_level]+my_opn_parn_loc[my_level]-9,(yyvsp[(3) - (5)]),strlen((yyvsp[(3) - (5)])));
                             strcat(my_temp[my_level-1],(yyvsp[(3) - (5)]));
...
/* Line 1806 of yacc.c  */
#line 89 "rasp_constituency_parse.y"
...
/* Line 1806 of yacc.c  */
#line 95 "rasp_constituency_parse.y"
...
/* Line 1806 of yacc.c  */
#line 100 "rasp_constituency_parse.y"
    { if (strcmp((yyvsp[(1) - (1)]),"?")==0)  { strcpy((yyvsp[(1) - (1)]),"question_mark"); }
                                    strcat(my_temp[my_level],(yyvsp[(1) - (1)]));
                           //         count1=count1+1;
...
/* Line 1806 of yacc.c  */
#line 109 "rasp_constituency_parse.y"
    { if (strcmp((yyvsp[(2) - (2)]),"?")==0) { strcpy((yyvsp[(2) - (2)]),"question_mark"); }
                                   strcat(my_temp[my_level],(yyvsp[(2) - (2)]));
                               //    count1=count1+1;
                                //   sprintf(buffer,"%d\0",count1);
                                 //  strcat(my_temp[my_level],buffer);
                                   strcat(my_temp[my_level]," ");
